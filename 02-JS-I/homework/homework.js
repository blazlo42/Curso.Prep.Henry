...
const nuevaString = "lionel messi";
let
var
...
tienenMismaLongitud("bueno", `perro`);
...
function redondearHaciaArriba(num) {
  ...
  // Tu código:
  var reodondeadoHaciaArriba = Math.ceil(num);
  return reodondeadoHaciaArriba;
}
